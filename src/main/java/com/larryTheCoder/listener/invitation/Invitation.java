...
public class Invitation {
    ...
    public void acceptInvitation() {
        ...
        List<IslandData> dataList = plugin.getFastCache().getIslandsFrom(receiver.getName());
        // Check if the player has an island
        if (!dataList.isEmpty()) {
            receiver.sendMessage(plugin.getPrefix() + "Deleting all of your islands");
            dataList.forEach((island) -> TaskManager.runTask(new DeleteIslandTask(plugin, island, receiver.getName())));
