...
public enum TableSet {
    ...
    ISLAND_DELETE_DATA("DELETE FROM islandData WHERE dataId = :id"),
    ISLAND_DELETE_MAIN("DELETE FROM island WHERE islandUniqueId = :id AND playerName = :player"),
    ISLAND_UPDATE_MAIN("UPDATE island SET islandId = :islandId, gridPosition = :gridPos, spawnPosition = :spawnPos, gridSize = :gridSize, levelName = :levelName, playerName = :plotOwner, islandName = :islandName, isUpSize = :isUpSize WHERE islandUniqueId = :islandUniqueId"),
